...
@Schema(description = "告警规则详情返回")
public class AlarmRuleDetailVO implements Serializable {
     ...
     * 窗口大小
     */
    @Schema(description = "窗口大小，最近 N 次数据", example = "1")
    private Integer windowSize;

    /**
     * 触发次数
     */
    @Schema(description = "触发次数，窗口内至少 N 次异常才触发", example = "1")
